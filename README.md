...
[![Open in Visual Studio Code](https://open.vscode.dev/badges/open-in-vscode.svg)](https://open.vscode.dev/qte77/App-K8s-HF-WnB)
...
For version history have a look at [CHANGELOG.md](./CHANGELOG.md).
